...
<span data-ttu-id="6acb0-113">**[Arquivos de terceiros na CDN](#Third-Party_Files_on_the_CDN_23)**</span><span class="sxs-lookup"><span data-stu-id="6acb0-113">**[Third-Party Files on the CDN](#Third-Party_Files_on_the_CDN_23)**</span></span>  
...
<span data-ttu-id="6acb0-173">Você pode usar scripts jQuery hospedados na CDN em seu aplicativo Web adicionando o seguinte elemento script a uma página:</span><span class="sxs-lookup"><span data-stu-id="6acb0-173">You can use jQuery scripts hosted on CDN in your Web application by adding the following script element to a page:</span></span>
...
#### <a name="jquery-version-341"></a><span data-ttu-id="6acb0-203">jQuery versão 3.4.1</span><span class="sxs-lookup"><span data-stu-id="6acb0-203">jQuery version 3.4.1</span></span>
...
#### <a name="jquery-version-311"></a><span data-ttu-id="6acb0-208">jQuery versão 3.1.1</span><span class="sxs-lookup"><span data-stu-id="6acb0-208">jQuery version 3.1.1</span></span>
...
#### <a name="jquery-version-222"></a><span data-ttu-id="6acb0-213">jQuery versão 2.2.2</span><span class="sxs-lookup"><span data-stu-id="6acb0-213">jQuery version 2.2.2</span></span>
...
#### <a name="jquery-version-1124"></a><span data-ttu-id="6acb0-225">jQuery versão 1.12.4</span><span class="sxs-lookup"><span data-stu-id="6acb0-225">jQuery version 1.12.4</span></span>
...
#### <a name="jquery-version-1112"></a><span data-ttu-id="6acb0-231">jQuery versão 1.11.2</span><span class="sxs-lookup"><span data-stu-id="6acb0-231">jQuery version 1.11.2</span></span>
...
#### <a name="jquery-version-191"></a><span data-ttu-id="6acb0-237">jQuery versão 1.9.1</span><span class="sxs-lookup"><span data-stu-id="6acb0-237">jQuery version 1.9.1</span></span>
...
#### <a name="jquery-version-172"></a><span data-ttu-id="6acb0-243">jQuery versão 1.7.2</span><span class="sxs-lookup"><span data-stu-id="6acb0-243">jQuery version 1.7.2</span></span>
...
#### <a name="jquery-version-142"></a><span data-ttu-id="6acb0-256">jQuery versão 1.4.2</span><span class="sxs-lookup"><span data-stu-id="6acb0-256">jQuery version 1.4.2</span></span>
...
#### <a name="jquery-migrate-version-121"></a><span data-ttu-id="6acb0-263">Migrar versão 1.2.1 do jQuery</span><span class="sxs-lookup"><span data-stu-id="6acb0-263">jQuery Migrate version 1.2.1</span></span>
...
- [<span data-ttu-id="6acb0-276">1.11.1 da IU do jQuery</span><span class="sxs-lookup"><span data-stu-id="6acb0-276">jQuery UI 1.11.1</span></span>](jquery-ui/cdnjqueryui1111.md "jQuery UI 1.11.1 na CDN do Microsoft Ajax")
...
- [<span data-ttu-id="6acb0-297">1.8.13 da IU do jQuery</span><span class="sxs-lookup"><span data-stu-id="6acb0-297">jQuery UI 1.8.13</span></span>](jquery-ui/cdnjqueryui1813.md "jQuery UI 1.8.13 na CDN do Microsoft Ajax")
...
- [<span data-ttu-id="6acb0-317">1.13.1 de validação jQuery</span><span class="sxs-lookup"><span data-stu-id="6acb0-317">jQuery Validate 1.13.1</span></span>](jquery-validate/cdnjqueryvalidate1131.md "Validação do jQuery 1.13.1")
...
- [<span data-ttu-id="6acb0-337">jQuery Mobile 1.3.1</span><span class="sxs-lookup"><span data-stu-id="6acb0-337">jQuery Mobile 1.3.1</span></span>](jquery-mobile/cdnjquerymobile131.md "jQuery Mobile 1.3.1 na CDN do Microsoft Ajax")
...
<span data-ttu-id="6acb0-375">As seguintes versões do [Knockout](http://www.knockoutjs.com "Separação") são hospedadas na CDN:</span><span class="sxs-lookup"><span data-stu-id="6acb0-375">The following releases of [Knockout](http://www.knockoutjs.com "Knockout") are hosted on the CDN:</span></span>
...
### <a name="globalize-releases-on-the-cdn"></a><span data-ttu-id="6acb0-376">Globalizar versões no CDN</span><span class="sxs-lookup"><span data-stu-id="6acb0-376">Globalize Releases on the CDN</span></span>

<span data-ttu-id="6acb0-377">As seguintes versões de [globalizate](https://github.com/jquery/globalize "Globalizar") são hospedadas na CDN:</span><span class="sxs-lookup"><span data-stu-id="6acb0-377">The following releases of [Globalize](https://github.com/jquery/globalize "Globalize") are hosted on the CDN:</span></span>

#### <a name="globalize-version-100"></a><span data-ttu-id="6acb0-378">Globalizar versão 1.0.0</span><span class="sxs-lookup"><span data-stu-id="6acb0-378">Globalize version 1.0.0</span></span>
...
#### <a name="globalize-version-011"></a><span data-ttu-id="6acb0-379">Globalizar versão 0.1.1</span><span class="sxs-lookup"><span data-stu-id="6acb0-379">Globalize version 0.1.1</span></span>

- https://ajax.aspnetcdn.com/ajax/globalize/0.1.1/globalize.min.js
- https://ajax.aspnetcdn.com/ajax/globalize/0.1.1/globalize.js
- https://ajax.aspnetcdn.com/ajax/globalize/0.1.1/cultures/globalize.cultures.js

    - <span data-ttu-id="6acb0-380">todas as culturas</span><span class="sxs-lookup"><span data-stu-id="6acb0-380">all cultures</span></span>
- https://ajax.aspnetcdn.com/ajax/globalize/0.1.1/cultures/globalize.culture.{culture-code}.js

    - <span data-ttu-id="6acb0-381">Substitua "{Culture-Code}" pelo código de cultura desejado, por exemplo, globalize.culture.en-GB.js= = Microsoft files na CDN = = essas bibliotecas foram carregadas pela Microsoft.</span><span class="sxs-lookup"><span data-stu-id="6acb0-381">Replace "{culture-code}" with the desired culture code, e.g. globalize.culture.en-GB.js== Microsoft Files on the CDN ==These libraries were uploaded by Microsoft.</span></span>

<a id="Respond_Releases_on_the_CDN_13"></a>

### <a name="respond-releases-on-the-cdn"></a><span data-ttu-id="6acb0-382">Responder a versões no CDN</span><span class="sxs-lookup"><span data-stu-id="6acb0-382">Respond Releases on the CDN</span></span>

<span data-ttu-id="6acb0-383">As seguintes versões de [resposta](https://github.com/scottjehl/Respond "Responder") estão hospedadas na CDN:</span><span class="sxs-lookup"><span data-stu-id="6acb0-383">The following releases of [Respond](https://github.com/scottjehl/Respond "Respond") are hosted on the CDN:</span></span>

#### <a name="respond-version-142"></a><span data-ttu-id="6acb0-384">Responder à versão 1.4.2</span><span class="sxs-lookup"><span data-stu-id="6acb0-384">Respond version 1.4.2</span></span>
...
#### <a name="respond-version-141"></a><span data-ttu-id="6acb0-385">Responder à versão 1.4.1</span><span class="sxs-lookup"><span data-stu-id="6acb0-385">Respond version 1.4.1</span></span>
...
#### <a name="respond-version-140"></a><span data-ttu-id="6acb0-386">Responder à versão 1.4.0</span><span class="sxs-lookup"><span data-stu-id="6acb0-386">Respond version 1.4.0</span></span>
...
#### <a name="respond-version-130"></a><span data-ttu-id="6acb0-387">Responder à versão 1.3.0</span><span class="sxs-lookup"><span data-stu-id="6acb0-387">Respond version 1.3.0</span></span>

- https://ajax.aspnetcdn.com/ajax/respond/1.3.0/respond.js

#### <a name="respond-version-120"></a><span data-ttu-id="6acb0-388">Responder à versão 1.2.0</span><span class="sxs-lookup"><span data-stu-id="6acb0-388">Respond version 1.2.0</span></span>

- https://ajax.aspnetcdn.com/ajax/respond/1.2.0/respond.js

<a id="Bootstrap_Releases_on_the_CDN_14"></a>

### <a name="bootstrap-releases-on-the-cdn"></a><span data-ttu-id="6acb0-389">Versões de Bootstrap no CDN</span><span class="sxs-lookup"><span data-stu-id="6acb0-389">Bootstrap Releases on the CDN</span></span>

<span data-ttu-id="6acb0-390">As seguintes versões da inicialização do [GetBootstrap.com](http://getbootstrap.com "getbootstrap.com") são hospedadas na CDN:</span><span class="sxs-lookup"><span data-stu-id="6acb0-390">The following releases of [getbootstrap.com](http://getbootstrap.com "getbootstrap.com") bootstrap are hosted on the CDN:</span></span>

#### <a name="bootstrap-version-450"></a><span data-ttu-id="6acb0-391">Versão do bootstrap 4.5.0</span><span class="sxs-lookup"><span data-stu-id="6acb0-391">Bootstrap version 4.5.0</span></span>
...
#### <a name="bootstrap-version-441"></a><span data-ttu-id="6acb0-392">Versão de inicialização 4.4.1</span><span class="sxs-lookup"><span data-stu-id="6acb0-392">Bootstrap version 4.4.1</span></span>
...
#### <a name="bootstrap-version-431"></a><span data-ttu-id="6acb0-393">Versão de Bootstrap 4.3.1</span><span class="sxs-lookup"><span data-stu-id="6acb0-393">Bootstrap version 4.3.1</span></span>
...
#### <a name="bootstrap-version-421"></a><span data-ttu-id="6acb0-394">Versão de inicialização 4.2.1</span><span class="sxs-lookup"><span data-stu-id="6acb0-394">Bootstrap version 4.2.1</span></span>
...
#### <a name="bootstrap-version-411"></a><span data-ttu-id="6acb0-395">Versão 4.1.1 do bootstrap</span><span class="sxs-lookup"><span data-stu-id="6acb0-395">Bootstrap version 4.1.1</span></span>
...
#### <a name="bootstrap-version-400"></a><span data-ttu-id="6acb0-396">Versão de inicialização 4.0.0</span><span class="sxs-lookup"><span data-stu-id="6acb0-396">Bootstrap version 4.0.0</span></span>
...
#### <a name="bootstrap-version-341"></a><span data-ttu-id="6acb0-397">Versão de inicialização 3.4.1</span><span class="sxs-lookup"><span data-stu-id="6acb0-397">Bootstrap version 3.4.1</span></span>
...
#### <a name="bootstrap-version-340"></a><span data-ttu-id="6acb0-398">Versão de inicialização 3.4.0</span><span class="sxs-lookup"><span data-stu-id="6acb0-398">Bootstrap version 3.4.0</span></span>
...
#### <a name="bootstrap-version-337"></a><span data-ttu-id="6acb0-399">Versão de inicialização 3.3.7</span><span class="sxs-lookup"><span data-stu-id="6acb0-399">Bootstrap version 3.3.7</span></span>
...
#### <a name="bootstrap-version-336"></a><span data-ttu-id="6acb0-400">Versão de inicialização 3.3.6</span><span class="sxs-lookup"><span data-stu-id="6acb0-400">Bootstrap version 3.3.6</span></span>
...
#### <a name="bootstrap-version-335"></a><span data-ttu-id="6acb0-401">Versão de inicialização 3.3.5</span><span class="sxs-lookup"><span data-stu-id="6acb0-401">Bootstrap version 3.3.5</span></span>
...
#### <a name="bootstrap-version-334"></a><span data-ttu-id="6acb0-402">Versão de inicialização 3.3.4</span><span class="sxs-lookup"><span data-stu-id="6acb0-402">Bootstrap version 3.3.4</span></span>
...
#### <a name="bootstrap-version-332"></a><span data-ttu-id="6acb0-403">Versão de inicialização 3.3.2</span><span class="sxs-lookup"><span data-stu-id="6acb0-403">Bootstrap version 3.3.2</span></span>
...
#### <a name="bootstrap-version-331"></a><span data-ttu-id="6acb0-404">Versão de inicialização 3.3.1</span><span class="sxs-lookup"><span data-stu-id="6acb0-404">Bootstrap version 3.3.1</span></span>
...
#### <a name="bootstrap-version-330"></a><span data-ttu-id="6acb0-405">Versão de inicialização 3.3.0</span><span class="sxs-lookup"><span data-stu-id="6acb0-405">Bootstrap version 3.3.0</span></span>
...
#### <a name="bootstrap-version-320"></a><span data-ttu-id="6acb0-406">Versão de inicialização 3.2.0</span><span class="sxs-lookup"><span data-stu-id="6acb0-406">Bootstrap version 3.2.0</span></span>
...
#### <a name="bootstrap-version-311"></a><span data-ttu-id="6acb0-407">Versão de inicialização 3.1.1</span><span class="sxs-lookup"><span data-stu-id="6acb0-407">Bootstrap version 3.1.1</span></span>
...
#### <a name="bootstrap-version-310"></a><span data-ttu-id="6acb0-408">Versão de inicialização 3.1.0</span><span class="sxs-lookup"><span data-stu-id="6acb0-408">Bootstrap version 3.1.0</span></span>
...
#### <a name="bootstrap-version-303"></a><span data-ttu-id="6acb0-409">Versão de inicialização 3.0.3</span><span class="sxs-lookup"><span data-stu-id="6acb0-409">Bootstrap version 3.0.3</span></span>
...
#### <a name="bootstrap-version-302"></a><span data-ttu-id="6acb0-410">Versão 3.0.2 do bootstrap</span><span class="sxs-lookup"><span data-stu-id="6acb0-410">Bootstrap version 3.0.2</span></span>
...
#### <a name="bootstrap-version-301"></a><span data-ttu-id="6acb0-411">Versão de Bootstrap 3.0.1</span><span class="sxs-lookup"><span data-stu-id="6acb0-411">Bootstrap version 3.0.1</span></span>
...
#### <a name="bootstrap-version-300"></a><span data-ttu-id="6acb0-412">Versão de inicialização 3.0.0</span><span class="sxs-lookup"><span data-stu-id="6acb0-412">Bootstrap version 3.0.0</span></span>
...
#### <a name="bootstrap-version-232"></a><span data-ttu-id="6acb0-413">Versão de inicialização 2.3.2</span><span class="sxs-lookup"><span data-stu-id="6acb0-413">Bootstrap version 2.3.2</span></span>
...
#### <a name="bootstrap-version-231"></a><span data-ttu-id="6acb0-414">Versão do bootstrap 2.3.1</span><span class="sxs-lookup"><span data-stu-id="6acb0-414">Bootstrap version 2.3.1</span></span>
...
### <a name="bootstrap-touchcarousel-releases-on-the-cdn"></a><span data-ttu-id="6acb0-415">Versões TouchCarousel de Bootstrap no CDN</span><span class="sxs-lookup"><span data-stu-id="6acb0-415">Bootstrap TouchCarousel Releases on the CDN</span></span>

<span data-ttu-id="6acb0-416">As seguintes versões das [https://github.com/ixisio/bootstrap-touch-carousel](https://github.com/ixisio/bootstrap-touch-carousel "https://github.com/ixisio/bootstrap-touch-carousel") versões de inicialização TouchCarousel são hospedadas na CDN:</span><span class="sxs-lookup"><span data-stu-id="6acb0-416">The following releases of [https://github.com/ixisio/bootstrap-touch-carousel](https://github.com/ixisio/bootstrap-touch-carousel "https://github.com/ixisio/bootstrap-touch-carousel") Bootstrap TouchCarousel releases are hosted on the CDN:</span></span>

#### <a name="bootstrap-touchcarousel-version-080"></a><span data-ttu-id="6acb0-417">Bootstrap TouchCarousel versão 0.8.0</span><span class="sxs-lookup"><span data-stu-id="6acb0-417">Bootstrap TouchCarousel version 0.8.0</span></span>
...
### <a name="hammerjs-releases-on-the-cdn"></a><span data-ttu-id="6acb0-418">Hammer.js versões no CDN</span><span class="sxs-lookup"><span data-stu-id="6acb0-418">Hammer.js Releases on the CDN</span></span>

<span data-ttu-id="6acb0-419">As seguintes versões de [http://hammerjs.github.io/](http://hammerjs.github.io/ "http://hammerjs.github.io/") Hammer.js versões são hospedadas na CDN:</span><span class="sxs-lookup"><span data-stu-id="6acb0-419">The following releases of [http://hammerjs.github.io/](http://hammerjs.github.io/ "http://hammerjs.github.io/") Hammer.js releases are hosted on the CDN:</span></span>

#### <a name="hammerjs-version-204"></a><span data-ttu-id="6acb0-420">Hammer.js versão 2.0.4</span><span class="sxs-lookup"><span data-stu-id="6acb0-420">Hammer.js version 2.0.4</span></span>
...
### <a name="aspnet-web-forms-and-ajax-releases-on-the-cdn"></a><span data-ttu-id="6acb0-421">Versões Web Forms e AJAX do ASP.NET no CDN</span><span class="sxs-lookup"><span data-stu-id="6acb0-421">ASP.NET Web Forms and Ajax Releases on the CDN</span></span>

<span data-ttu-id="6acb0-422">As seguintes versões da biblioteca do ASP.NET AJAX são hospedadas na CDN.</span><span class="sxs-lookup"><span data-stu-id="6acb0-422">The following releases of the ASP.NET Ajax Library are hosted on the CDN.</span></span> <span data-ttu-id="6acb0-423">Clique em cada link para ver a lista real de arquivos.</span><span class="sxs-lookup"><span data-stu-id="6acb0-423">Click each link to see the actual list of files.</span></span>

- [<span data-ttu-id="6acb0-424">ASP.NET Web Forms e Ajax versão 4.5.2</span><span class="sxs-lookup"><span data-stu-id="6acb0-424">ASP.NET Web Forms and Ajax version 4.5.2</span></span>](cdnajax452.md "Web Forms do ASP.NET e Ajax 4.5.2")
- [<span data-ttu-id="6acb0-425">ASP.NET Web Forms e Ajax versão 4</span><span class="sxs-lookup"><span data-stu-id="6acb0-425">ASP.NET Web Forms and Ajax version 4</span></span>](cdnajax4.md "Web Forms do ASP.NET e Ajax 4")
- [<span data-ttu-id="6acb0-426">ASP.NET AJAX versão 3,5</span><span class="sxs-lookup"><span data-stu-id="6acb0-426">ASP.NET Ajax version 3.5</span></span>](cdnajax35.md "ASP.NET Ajax 3.5")

<a id="ASPNET_MVC_Releases_on_the_CDN_16"></a>

### <a name="aspnet-mvc-releases-on-the-cdn"></a><span data-ttu-id="6acb0-427">Versões MVC do ASP.NET no CDN</span><span class="sxs-lookup"><span data-stu-id="6acb0-427">ASP.NET MVC Releases on the CDN</span></span>

<span data-ttu-id="6acb0-428">Os seguintes arquivos JavaScript do ASP.NET MVC são hospedados nesta CDN:</span><span class="sxs-lookup"><span data-stu-id="6acb0-428">The following ASP.NET MVC JavaScript files are hosted on this CDN:</span></span>

#### <a name="aspnet-mvc-523"></a><span data-ttu-id="6acb0-429">ASP.NET MVC 5.2.3</span><span class="sxs-lookup"><span data-stu-id="6acb0-429">ASP.NET MVC 5.2.3</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/5.2.3/jquery.validate.unobtrusive.js
- https://ajax.aspnetcdn.com/ajax/mvc/5.2.3/jquery.validate.unobtrusive.min.js

#### <a name="aspnet-mvc-51"></a><span data-ttu-id="6acb0-430">ASP.NET MVC 5,1</span><span class="sxs-lookup"><span data-stu-id="6acb0-430">ASP.NET MVC 5.1</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/5.1/jquery.validate.unobtrusive.js
- https://ajax.aspnetcdn.com/ajax/mvc/5.1/jquery.validate.unobtrusive.min.js

#### <a name="aspnet-mvc-50"></a><span data-ttu-id="6acb0-431">ASP.NET MVC 5,0</span><span class="sxs-lookup"><span data-stu-id="6acb0-431">ASP.NET MVC 5.0</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/5.0/jquery.validate.unobtrusive.js
- https://ajax.aspnetcdn.com/ajax/mvc/5.0/jquery.validate.unobtrusive.min.js

#### <a name="aspnet-mvc-40"></a><span data-ttu-id="6acb0-432">ASP.NET MVC 4.0</span><span class="sxs-lookup"><span data-stu-id="6acb0-432">ASP.NET MVC 4.0</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/4.0/jquery.validate.unobtrusive.js
- https://ajax.aspnetcdn.com/ajax/mvc/4.0/jquery.validate.unobtrusive.min.js

#### <a name="aspnet-mvc-30"></a><span data-ttu-id="6acb0-433">ASP.NET MVC 3.0</span><span class="sxs-lookup"><span data-stu-id="6acb0-433">ASP.NET MVC 3.0</span></span>
...
#### <a name="aspnet-mvc-20"></a><span data-ttu-id="6acb0-434">ASP.NET MVC 2,0</span><span class="sxs-lookup"><span data-stu-id="6acb0-434">ASP.NET MVC 2.0</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/2.0/MicrosoftMvcAjax.js
- https://ajax.aspnetcdn.com/ajax/mvc/2.0/MicrosoftMvcAjax.debug.js

#### <a name="aspnet-mvc-10"></a><span data-ttu-id="6acb0-435">ASP.NET MVC 1,0</span><span class="sxs-lookup"><span data-stu-id="6acb0-435">ASP.NET MVC 1.0</span></span>
...
### <a name="aspnet-signalr-releases-on-the-cdn"></a><span data-ttu-id="6acb0-436">Versões do Signalr ASP.NET no CDN</span><span class="sxs-lookup"><span data-stu-id="6acb0-436">ASP.NET SignalR Releases on the CDN</span></span>

<span data-ttu-id="6acb0-437">Os seguintes arquivos JavaScript do Signalr ASP.NET são hospedados nesta CDN:</span><span class="sxs-lookup"><span data-stu-id="6acb0-437">The following ASP.NET SignalR JavaScript files are hosted on this CDN:</span></span>

#### <a name="aspnet-signalr-222"></a><span data-ttu-id="6acb0-438">ASP.NET Signalr 2.2.2</span><span class="sxs-lookup"><span data-stu-id="6acb0-438">ASP.NET SignalR 2.2.2</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.2.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.2.js

#### <a name="aspnet-signalr-221"></a><span data-ttu-id="6acb0-439">ASP.NET Signalr 2.2.1</span><span class="sxs-lookup"><span data-stu-id="6acb0-439">ASP.NET SignalR 2.2.1</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.1.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.1.js

#### <a name="aspnet-signalr-220"></a><span data-ttu-id="6acb0-440">ASP.NET Signalr 2.2.0</span><span class="sxs-lookup"><span data-stu-id="6acb0-440">ASP.NET SignalR 2.2.0</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.0.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.0.js

#### <a name="aspnet-signalr-210"></a><span data-ttu-id="6acb0-441">ASP.NET Signalr 2.1.0</span><span class="sxs-lookup"><span data-stu-id="6acb0-441">ASP.NET SignalR 2.1.0</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.1.0.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.1.0.js

#### <a name="aspnet-signalr-203"></a><span data-ttu-id="6acb0-442">ASP.NET Signalr 2.0.3</span><span class="sxs-lookup"><span data-stu-id="6acb0-442">ASP.NET SignalR 2.0.3</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.3.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.3.js

#### <a name="aspnet-signalr-202"></a><span data-ttu-id="6acb0-443">ASP.NET Signalr 2.0.2</span><span class="sxs-lookup"><span data-stu-id="6acb0-443">ASP.NET SignalR 2.0.2</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.2.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.2.js

#### <a name="aspnet-signalr-201"></a><span data-ttu-id="6acb0-444">ASP.NET Signalr 2.0.1</span><span class="sxs-lookup"><span data-stu-id="6acb0-444">ASP.NET SignalR 2.0.1</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.1.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.1.js

#### <a name="aspnet-signalr-200"></a><span data-ttu-id="6acb0-445">ASP.NET Signalr 2.0.0</span><span class="sxs-lookup"><span data-stu-id="6acb0-445">ASP.NET SignalR 2.0.0</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.0.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.0.js

#### <a name="aspnet-signalr-113"></a><span data-ttu-id="6acb0-446">ASP.NET Signalr 1.1.3</span><span class="sxs-lookup"><span data-stu-id="6acb0-446">ASP.NET SignalR 1.1.3</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.3.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.3.js

#### <a name="aspnet-signalr-112"></a><span data-ttu-id="6acb0-447">Sinalização ASP.NET 1.1.2</span><span class="sxs-lookup"><span data-stu-id="6acb0-447">ASP.NET SignalR 1.1.2</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.2.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.2.js

#### <a name="aspnet-signalr-111"></a><span data-ttu-id="6acb0-448">ASP.NET Signalr 1.1.1</span><span class="sxs-lookup"><span data-stu-id="6acb0-448">ASP.NET SignalR 1.1.1</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.1.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.1.js

#### <a name="aspnet-signalr-110"></a><span data-ttu-id="6acb0-449">ASP.NET Signalr 1.1.0</span><span class="sxs-lookup"><span data-stu-id="6acb0-449">ASP.NET SignalR 1.1.0</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.0.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.0.js

#### <a name="aspnet-signalr-101"></a><span data-ttu-id="6acb0-450">ASP.NET Signalr 1.0.1</span><span class="sxs-lookup"><span data-stu-id="6acb0-450">ASP.NET SignalR 1.0.1</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.0.1.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.0.1.js

<span data-ttu-id="6acb0-451">Para obter informações sobre os termos de uso da CDN, consulte [termos de uso da CDN do Microsoft Ajax](https://www.asp.net/terms-of-use "Termos de uso da CDN do Microsoft Ajax").</span><span class="sxs-lookup"><span data-stu-id="6acb0-451">For information about the terms of use for the CDN, see [Microsoft Ajax CDN Terms of Use](https://www.asp.net/terms-of-use "Microsoft Ajax CDN Terms of Use").</span></span>
