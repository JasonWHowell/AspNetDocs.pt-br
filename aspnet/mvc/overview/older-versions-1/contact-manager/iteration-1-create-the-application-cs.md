...
---
# <a name="iteration-1--create-the-application-c"></a>Iteração nº 1 – criar o aplicativo (C#)
...
**Figura 01**: A caixa de diálogo Novo Projeto[(Clique para exibir imagem em tamanho real)](iteration-1-create-the-application-cs/_static/image2.png)
...
**Figura 02**: A caixa de diálogo Projeto de teste da unidade de criação[(clique para exibir a imagem em tamanho real)](iteration-1-create-the-application-cs/_static/image4.png)
...
**Figura 03**: A janela Solution Explorer[(Clique para ver a imagem em tamanho real)](iteration-1-create-the-application-cs/_static/image6.png)
...
\Controladores\HomeControllerTest.cs
...
**Figura 04**: Criação de um novo banco de dados Microsoft SQL Server Express[(Clique para ver imagem em tamanho real)](iteration-1-create-the-application-cs/_static/image8.png)
...
**Figura 05**: O Designer da Tabela do Banco de Dados[(Clique para ver a imagem em tamanho real)](iteration-1-create-the-application-cs/_static/image10.png)
...
**Figura 06**: A caixa de diálogo Adicionar novo item[(Clique para exibir a imagem em tamanho real)](iteration-1-create-the-application-cs/_static/image12.png)
...
**Figura 07**: Escolha conteúdo do modelo ([Clique para ver a imagem em tamanho real](iteration-1-create-the-application-cs/_static/image14.png))
...
**Figura 08**: Escolha sua conexão de dados[(Clique para ver a imagem em tamanho real)](iteration-1-create-the-application-cs/_static/image16.png)
...
**Figura 09**: Escolha seus objetos de banco de dados ([Clique para ver a imagem em tamanho real](iteration-1-create-the-application-cs/_static/image18.png))
...
**Figura 10**: A classe Contato[(Clique para ver a imagem em tamanho real)](iteration-1-create-the-application-cs/_static/image20.png)
...
**Figura 11**: Adicionando o controlador Home[(Clique para exibir a imagem em tamanho real)](iteration-1-create-the-application-cs/_static/image22.png)
...
**Figura 12**: Adicionando a exibição Índice[(Clique para exibir imagem em tamanho real)](iteration-1-create-the-application-cs/_static/image24.png)

Na **caixa de** diálogo Adicionar exibição, marque a caixa de seleção rotulada **Criar uma exibição fortemente digitada**. Selecione a classe de dados Exibir ContactManager.Models.Contact e a Lista de conteúdo Exibir. A seleção dessas opções gera uma exibição que exibe uma lista de registros de contato.
...
**Figura 13**: A caixa de diálogo Adicionar exibição[(Clique para exibir a imagem em tamanho real)](iteration-1-create-the-application-cs/_static/image26.png)
...
**Figura 14**: Habilitação da depuração[(Clique para exibir imagem em tamanho real)](iteration-1-create-the-application-cs/_static/image28.png)
...
**Figura 15**: A exibição Índice[(Clique para ver a imagem em tamanho real)](iteration-1-create-the-application-cs/_static/image30.png)
...
**Listagem 4 - Controladores\HomeController.cs (com métodos de criação)**
...
**Figura 16**: Adicionando a exibição Criar[(Clique para exibir imagem em tamanho real)](iteration-1-create-the-application-cs/_static/image32.png)

Na caixa de diálogo **Adicionar exibição,** selecione a classe **ContactManager.Models.Contact** e a opção **Criar** para exibir conteúdo (consulte Figura 17). Quando você **clica** no botão Adicionar, uma exibição Criar é gerada automaticamente.
...
**Figura 17**: Ver uma página explodir[(Clique para ver a imagem em tamanho real)](iteration-1-create-the-application-cs/_static/image34.png)
...
**Figura 18**: A exibição criar ([Clique para ver a imagem em tamanho real](iteration-1-create-the-application-cs/_static/image36.png))
...
**Listagem 6 - Controladores\HomeController.cs (com métodos de edição)**
...
**Figura 19**: Adicionando uma exibição de edição[(Clique para exibir imagem em tamanho real)](iteration-1-create-the-application-cs/_static/image38.png)
...
**Lista 8 - Controladores\HomeController.cs (Métodos de exclusão)**
...
**Figura 20**: A exibição de confirmação de exclusão[(Clique para exibir a imagem em tamanho real)](iteration-1-create-the-application-cs/_static/image40.png)
...
**Figura 21**: Exibição de índice com link de edição[(Clique para ver imagem em tamanho real)](iteration-1-create-the-application-cs/_static/image42.png)
...
**Figura 22**: Adicionando a exibição de confirmação de exclusão[(Clique para exibir a imagem em tamanho real)](iteration-1-create-the-application-cs/_static/image44.png)
...
Este problema é fácil de resolver. Primeiro, precisamos refatorar o nome do controlador doméstico. Abra a classe HomeController no Visual Studio Code Editor, clique com o botão direito do mouse no nome da classe e selecione a opção de menu **Refator, Rename**. A seleção desta opção de menu abre a caixa de diálogo Renomear.
...
**Figura 23**: Refatoração de um nome de controlador[(Clique para exibir imagem em tamanho real)](iteration-1-create-the-application-cs/_static/image46.png)
...
**Figura 24**: Usando a caixa de diálogo Renomear[(Clique para exibir a imagem em tamanho real)](iteration-1-create-the-application-cs/_static/image48.png)
...
**Figura 25**: Sem controlador padrão[(Clique para exibir imagem em tamanho real](iteration-1-create-the-application-cs/_static/image50.png))
