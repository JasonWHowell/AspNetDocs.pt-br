...
title: 'Iteração #4 – Faça a aplicação livremente acoplada (VB) | Microsoft Docs'
...
ms.locfileid: "81542762"
---
# <a name="iteration-4--make-the-application-loosely-coupled-vb"></a>Iteração nº 4 – tornar o aplicativo fracamente acoplado (VB)
...
**Listagem 1 - Modelos\IContactManagerRepository.vb**
...
**Listagem 2 - Modelos\EntidadeContactManagerRepository.vb**
...
**Listagem 3 - Controladores\ContactController.vb**
...
**Listagem 4 - Modelos\ContactManagerService.vb**
...
**Listagem 5 - Modelos\IContactManagerService.vb**
...
**Lista 6 - Controladores\ContactController.vb**
...
**Lista 7 - Modelos\Validação\ModelStateWrapper.vb**

[!code-vb[Main](iteration-4-make-the-application-loosely-coupled-vb/samples/sample7.vb)]

**Lista 8 - Modelos\Validação\IValidaçãoDictionary.vb**
