...
title: 'Iteração #5 – Criar testes unitários (VB) | Microsoft Docs'
...
ms.locfileid: "81542333"
---
# <a name="iteration-5--create-unit-tests-vb"></a>Iteração nº 5 – criar testes de unidade (VB)
...
4. Adicione uma referência ao conjunto Moq ao seu projeto teste selecionando a opção menu **Projeto, Adicione referência** para abrir a caixa de diálogo **Adicionar referência.** Na guia Procurar, navegue até a pasta onde você descompactou moq e selecione o conjunto Moq.dll. Clique no botão **OK** (ver Figura 2).
...
**Figura 01**: Desbloqueando moq[(Clique para ver imagem em tamanho real](iteration-5-create-unit-tests-vb/_static/image2.png))

[![Referências após a adição do Moq](iteration-5-create-unit-tests-vb/_static/image2.jpg)](iteration-5-create-unit-tests-vb/_static/image3.png)

**Figura 02**: Referências após a adição de Moq[(Clique para exibir imagem em tamanho real)](iteration-5-create-unit-tests-vb/_static/image4.png)
...
**Figura 03:** Modelos\ContactManagerServiceTest.cs[(Clique para exibir imagem em tamanho real)](iteration-5-create-unit-tests-vb/_static/image6.png)
...
**Listagem 1 - Modelos\ContactManagerServiceTest.vb**
...
[![Resultados do teste](iteration-5-create-unit-tests-vb/_static/image4.jpg)](iteration-5-create-unit-tests-vb/_static/image7.png)

**Figura 04**: Resultados do teste[(Clique para ver a imagem em tamanho real](iteration-5-create-unit-tests-vb/_static/image8.png))

## <a name="creating-unit-tests-for-controllers"></a>Criação de testes unitários para controladores

ASP.NET aplicativo MVC controlam o fluxo de interação do usuário. Ao testar um controlador, você deseja testar se o controlador retorna o resultado de ação certo e visualiza os dados. Você também pode querer testar se um controlador interage com as classes de modelo da maneira esperada.
...
**Listagem 2 - Controladores\ContactControllerTest.vb**
