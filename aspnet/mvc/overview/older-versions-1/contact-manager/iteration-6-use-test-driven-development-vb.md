...
---
# <a name="iteration-6--use-test-driven-development-vb"></a>Iteração nº 6 – usar desenvolvimento controlado por testes (VB)
...
Crie um novo teste de unidade clicando com o botão direito do mouse na pasta Controladores no projeto ContactManager.Tests, selecionando **Adicionar, Novo Teste**e selecionando o modelo **de teste** de unidade (ver Figura 1). Nomeie o novo teste de unidade GroupControllerTest.vb e clique no botão **OK.**

[![Adicionando o teste da unidade GroupControllerTest](iteration-6-use-test-driven-development-vb/_static/image1.jpg)](iteration-6-use-test-driven-development-vb/_static/image1.png)

**Figura 01**: Adicionando o teste da unidade GroupControllerTest[(Clique para exibir imagem em tamanho real)](iteration-6-use-test-driven-development-vb/_static/image2.png)
...
**Listagem 1 - Controladores\GroupControllerTest.vb**
...
**Listagem 2 - Controladores\GroupController.vb**
...
**Figura 02**: Sucesso! (Clique[para ver a imagem em tamanho real](iteration-6-use-test-driven-development-vb/_static/image4.png))
...
**Listagem 4 - Controladores\GroupControllerTest.vb**
...
**Lista 5 - Controladores\GroupController.vb**
...
**Listagem 6 - Controladores\GroupControllerTest.vb**
...
**Listagem 8 - Controladores\GroupController.vb**
...
**Listagem 9 - Controladores\GroupController.vb**

[!code-vb[Main](iteration-6-use-test-driven-development-vb/samples/sample9.vb)]

**Listagem 10 - Controladores\ContactManagerService.vb**

[!code-vb[Main](iteration-6-use-test-driven-development-vb/samples/sample10.vb)]

**Listagem 11 - Controladores\FakeContactManagerRepository.vb**
...
**Listagem 12 - Controladores\GroupControllerTest.vb**
...
[![Criando uma relação de tabela de banco de dados](iteration-6-use-test-driven-development-vb/_static/image3.jpg)](iteration-6-use-test-driven-development-vb/_static/image5.png)

**Figura 03**: Criação de uma relação de tabela de banco de dados[(Clique para ver imagem em tamanho real)](iteration-6-use-test-driven-development-vb/_static/image6.png)

[![Especificando relacionamentos de tabela](iteration-6-use-test-driven-development-vb/_static/image4.jpg)](iteration-6-use-test-driven-development-vb/_static/image7.png)

**Figura 04**: Especificando relações de tabela[(Clique para exibir imagem em tamanho real)](iteration-6-use-test-driven-development-vb/_static/image8.png)
...
[![Atualizando um modelo de framework de entidades a partir do banco de dados](iteration-6-use-test-driven-development-vb/_static/image5.jpg)](iteration-6-use-test-driven-development-vb/_static/image9.png)

**Figura 05**: Atualização de um modelo de quadro de entidades a partir do banco de dados[(Clique para exibir imagem em tamanho real](iteration-6-use-test-driven-development-vb/_static/image10.png))
...
[![Entity Designer exibindo Grupo e Contato](iteration-6-use-test-driven-development-vb/_static/image6.jpg)](iteration-6-use-test-driven-development-vb/_static/image11.png)

**Figura 06**: Entity Designer exibindo Grupo e Contato[(Clique para exibir imagem em tamanho real)](iteration-6-use-test-driven-development-vb/_static/image12.png)
...
**Listagem 14 - Modelos\IContactManagerRepository.vb**

[!code-vb[Main](iteration-6-use-test-driven-development-vb/samples/sample14.vb)]

Na verdade, não implementamos nenhum dos métodos relacionados ao trabalho com grupos de contato em nossa classe real EntityContactManagerRepository. Atualmente, a classe EntityContactManagerRepository possui métodos de stub para cada um dos métodos de grupo de contato listados na interface IContactManagerRepository. Por exemplo, o método ListGroups() atualmente se parece com isso:
...
**Listagem 13 - Modelos\EntidadeContactManagerRepository.vb**
...
[![A visão do Índice de Grupo](iteration-6-use-test-driven-development-vb/_static/image7.jpg)](iteration-6-use-test-driven-development-vb/_static/image13.png)

**Figura 07**: A exibição Índice de Grupo[(Clique para ver a imagem em tamanho real)](iteration-6-use-test-driven-development-vb/_static/image14.png)
...
**Figura 08**: A exibição índice de contato[(Clique para ver imagem em tamanho real)](iteration-6-use-test-driven-development-vb/_static/image16.png)
...
> [anterior](iteration-7-add-ajax-functionality-vb.md)
