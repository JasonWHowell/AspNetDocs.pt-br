...
---
# <a name="iteration-7--add-ajax-functionality-vb"></a>Iteração nº 7 – adicionar funcionalidade do Ajax (VB)
...
[![Atualizando apenas contatos](iteration-7-add-ajax-functionality-vb/_static/image1.jpg)](iteration-7-add-ajax-functionality-vb/_static/image1.png)

**Figura 01**: Atualização apenas contatos[(Clique para ver imagem em tamanho real)](iteration-7-add-ajax-functionality-vb/_static/image2.png)
...
**Listagem 3 - Controladores\ContactController.vb (método de índice)**
...
**Figura 02**: A página de confirmação de exclusão[(Clique para exibir imagem em tamanho real)](iteration-7-add-ajax-functionality-vb/_static/image4.png)
...
**Lista 7 - Controladores\ContactController.vb (AjaxDelete)**   
