...
**Figura 1**: Detectando o modo de processamento de solicitação[(Clique para exibir a imagem em tamanho real)](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image2.png)
...
**Figura 2**: Receber um erro 404 Não Encontrado[(Clique para exibir a imagem em tamanho real](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image4.png))
...
**Figura 3**: Criação de um mapa de script curinga com IIS 7.0[(Clique para ver imagem em tamanho real)](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image6.png)
...
**Figura 4**: Criação de um mapa de script curinga com IIS 6.0[(Clique para ver imagem em tamanho real)](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image8.png)
...
**Figura 5**: Erro de rota raiz ausente[(Clique para exibir imagem em tamanho real](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image10.png))
