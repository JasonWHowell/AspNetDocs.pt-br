...
**Figura 1**: Adicionar uma referência ao Binder modelo de anotações de dados[(Clique para exibir a imagem em tamanho real)](validation-with-the-data-annotation-validators-cs/_static/image3.png)
...
Esta linha de código registra as ataAnnotaçõesModelBinder como o aglutinante de modelo padrão para toda a aplicação ASP.NET MVC.
...
**Figura 6**: Usando validadores com o Framework Entity ([Clique para exibir imagem em tamanho real](validation-with-the-data-annotation-validators-cs/_static/image14.png))
