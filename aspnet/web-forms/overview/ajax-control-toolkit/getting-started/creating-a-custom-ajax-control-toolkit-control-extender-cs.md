...
title: Criando um extensor de controle do kit de ferramentas de controle AJAX personalizado (C#) | Microsoft Docs
...
>  [Avançar](get-started-with-the-ajax-control-toolkit-vb.md)
